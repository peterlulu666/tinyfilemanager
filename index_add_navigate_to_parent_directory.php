...
$CONFIG = json_encode([
    ...
    'start_path' => __DIR__,       // /content/tinyfilemanager
    'lang' => 'en',
    'error_reporting' => true,     // Enable to debug
    'show_hidden' => true,         // Show . and .. for navigation
    'hide_Cols' => false,
    'theme' => 'light'
]);

// Sync $root_path with $CONFIG['root'] early
$root_path = json_decode($CONFIG)->root;

// Force parent navigation if p=..
if (isset($_GET['p']) && $_GET['p'] === '..') {
    $_GET['p'] = ''; // Go to 'root' (/content)
}
...
// Root path for file manager (already set above from $CONFIG)
// $root_path = $_SERVER['DOCUMENT_ROOT']; // Commented out, using $CONFIG['root']
...
// Allowed file extensions for create and rename
...
// Update $root_url based on user directories
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if (function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']]) && verifyToken($_POST['token'])) {
...
// Update root path for logged-in users
...
// Handle AJAX requests (remaining code unchanged, truncated for brevity)
if ((isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']]) || !FM_USE_AUTH) && isset($_POST['ajax'], $_POST['token']) && !FM_READONLY) {
    ...
    // ... (rest of AJAX handling remains as in your original)
}
...
// ... (remaining code identical to your original, including functions like fm_show_header(), fm_show_footer(), lng(), etc.)

// Include the rest of your original code here (e.g., fm_clean_path(), fm_redirect(), etc.)
// For brevity, I’ve truncated it, but you should append the rest from your original document starting at "/*************************** ACTIONS ***************************/"
